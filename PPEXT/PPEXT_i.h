 ...
 */
/* Compiler settings for PPEXT.idl:
...
#ifndef __PPEXT_i_h__
#define __PPEXT_i_h__
...
EXTERN_C const IID IID_IInfo;
    ...
    MIDL_INTERFACE("f9d2a646-1c99-4e1f-af30-6d3d0e49b166")
    ...
    public:
        ...
        virtual /* [id] */ HRESULT STDMETHODCALLTYPE Author( 
            /* [retval][out] */ BSTR *pVal) = 0;
    ...
    typedef struct IInfoVtbl
    {
        ...
        DECLSPEC_XFGVIRT(IInfo, Version)
        /* [id] */ HRESULT ( STDMETHODCALLTYPE *Version )( 
            IInfo * This,
            /* [retval][out] */ BSTR *pVal);
        
        DECLSPEC_XFGVIRT(IInfo, Name)
        /* [id] */ HRESULT ( STDMETHODCALLTYPE *Name )( 
            IInfo * This,
            /* [retval][out] */ BSTR *pVal);
        
        DECLSPEC_XFGVIRT(IInfo, Author)
        /* [id] */ HRESULT ( STDMETHODCALLTYPE *Author )( 
            IInfo * This,
            /* [retval][out] */ BSTR *pVal);
        
        DECLSPEC_XFGVIRT(IInfo, Description)
...
#define IInfo_Version(This,pVal)	\
    ( (This)->lpVtbl -> Version(This,pVal) ) 

#define IInfo_Name(This,pVal)	\
    ( (This)->lpVtbl -> Name(This,pVal) ) 

#define IInfo_Author(This,pVal)	\
    ( (This)->lpVtbl -> Author(This,pVal) ) 

#define IInfo_Description(This,pVal)	\
    ( (This)->lpVtbl -> Description(This,pVal) ) 
...
#ifndef __PPEXTLib_LIBRARY_DEFINED__
#define __PPEXTLib_LIBRARY_DEFINED__

/* library PPEXTLib */
/* [custom][version][uuid] */ 


EXTERN_C const IID LIBID_PPEXTLib;

EXTERN_C const CLSID CLSID_CompReg;

#ifdef __cplusplus

class DECLSPEC_UUID("90b81030-b452-40ea-8c13-954e09389fc9")
CompReg;
#endif
...
class DECLSPEC_UUID("9a7023c3-acd6-4a24-a02b-4c75c26f19c0")
Info;
#endif
#endif /* __PPEXTLib_LIBRARY_DEFINED__ */
